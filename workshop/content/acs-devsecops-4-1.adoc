...
image::images/acs-images-new/ci-1.png[]

Press the *Generate Token* button in the top right corner and select the token role of "Continuous Integration" with any expiry date.  Give the token a name and press the button titled "Generate".

image::images/acs-images-new/ci-2.png[]
...
image::images/acs-images-new/pipeline-1.png[]
