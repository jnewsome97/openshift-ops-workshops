...
----
NAME                    READY   STATUS    RESTARTS   AGE
mapit-85ddc7b8f-9h65k   1/1     Running   0          102s
[ec2-user@bastion ~]$ oc describe pod -l deployment=mapit
Name:         mapit-85ddc7b8f-9h65k
Namespace:    app-management
Priority:     0
Node:         ip-10-0-61-146.us-east-2.compute.internal/10.0.61.146
Start Time:   Mon, 17 Jun 2024 13:55:56 +0000
Labels:       deployment=mapit
              pod-template-hash=85ddc7b8f
Annotations:  k8s.ovn.org/pod-networks:
                {"default":{"ip_addresses":["10.128.2.94/23"],"mac_address":"0a:58:0a:80:02:5e","gateway_ips":["10
.128.2.1"],"routes":[{"dest":"10.128.0.0...
...
Containers:
  mapit:
    Container ID:   cri-o://6e434835bbda7f61a5efd692d44665506c285e328e30f134a60e5df9252b167c
...
9efd1de9d
    ...
    State:          Running
      Started:      Mon, 17 Jun 2024 13:56:14 +0000
    Ready:          True
    Restart Count:  0
    Environment:    <none>
    Mounts:
      /var/run/secrets/kubernetes.io/serviceaccount from kube-api-access-gtlg6 (ro)
Conditions:
  Type              Status
  Initialized       True
  Ready             True
...
Events:
  ...
  ----    ------          ----  ----               -------
  Normal  Scheduled       106s  default-scheduler  Successfully assigned app-management/mapit-85ddc7b8f-9h65k to i
p-10-0-61-146.us-east-2.compute.internal
  Normal  AddedInterface  106s  multus             Add eth0 [10.128.2.94/23] from ovn-kubernetes
  Normal  Pulling         106s  kubelet            Pulling image "quay.io/openshiftroadshow/mapit@sha256:1366b430c
7d4bddf35c7b2d067bc24e8d67ba297dbaacd10e0d80939efd1de9d"
  Normal  Pulled          90s   kubelet            Successfully pulled image "quay.io/openshiftroadshow/mapit@sha2
56:1366b430c7d4bddf35c7b2d067bc24e8d67ba297dbaacd10e0d80939efd1de9d" in 16.201s (16.201s including waiting)
  Normal  Created         89s   kubelet            Created container mapit
  Normal  Started         89s   kubelet            Started container mapit
----
...
TargetPort:        8080/TCP
Endpoints:         10.128.2.94:8080
Port:              8778-tcp  8778/TCP
TargetPort:        8778/TCP
Endpoints:         10.128.2.94:8778
Port:              9779-tcp  9779/TCP
TargetPort:        9779/TCP
Endpoints:         10.128.2.94:9779
...
metadata:
  annotations:
    openshift.io/generated-by: OpenShiftNewApp
  creationTimestamp: "2024-06-17T13:55:56Z"
  labels:
    app: mapit
    app.kubernetes.io/component: mapit
    app.kubernetes.io/instance: mapit
  name: mapit
  namespace: app-management
  resourceVersion: "128343"
  uid: 12f9b20b-2ff9-4924-8d06-2e965b217a95
spec:
  clusterIP: 172.30.239.63
  clusterIPs:
  - 172.30.239.63
...
Port:              8080-tcp  8080/TCP
TargetPort:        8080/TCP
Endpoints:         10.128.2.94:8080,10.131.0.99:8080
Port:              8778-tcp  8778/TCP
TargetPort:        8778/TCP
Endpoints:         10.128.2.94:8778,10.131.0.99:8778
Port:              9779-tcp  9779/TCP
TargetPort:        9779/TCP
Endpoints:         10.128.2.94:9779,10.131.0.99:9779
Session Affinity:  None
Events:            <none>
----
