...
----
Name:             mapit-85ddc7b8f-kp4qm
Namespace:        app-management
Priority:         0
Service Account:  default
Node:             ip-10-0-6-27.us-east-2.compute.internal/10.0.6.27
Start Time:       Mon, 01 Jul 2024 14:09:05 +0000
Labels:           deployment=mapit
                  pod-template-hash=85ddc7b8f
Annotations:      k8s.ovn.org/pod-networks:
                    {"default":{"ip_addresses":["10.128.2.103/23"],"mac_address":"0a:58:0a:80:02:67","gateway_ips"
:["10.128.2.1"],"routes":[{"dest":"10.128.0....
...
Containers:
  mapit:
    Container ID:   cri-o://dcc32474540cb03726f9cf361211496752add5ac2fb215192fd2dcc9274b9587
...
9efd1de9d
    ...
    State:          Running
      Started:      Mon, 01 Jul 2024 14:09:13 +0000
    Ready:          True
    Restart Count:  0
    Environment:    <none>
    Mounts:
      /var/run/secrets/kubernetes.io/serviceaccount from kube-api-access-qv5vq (ro)
Conditions:
  Type              Status
  Initialized       True
  Ready             True
...
Events:
  ...
  ----    ------          ----  ----               -------
  Normal  Scheduled       65s   default-scheduler  Successfully assigned app-management/mapit-85ddc7b8f-kp4qm to i
p-10-0-6-27.us-east-2.compute.internal
  Normal  AddedInterface  65s   multus             Add eth0 [10.128.2.103/23] from ovn-kubernetes
  Normal  Pulling         65s   kubelet            Pulling image "quay.io/openshiftroadshow/mapit@sha256:1366b430c
7d4bddf35c7b2d067bc24e8d67ba297dbaacd10e0d80939efd1de9d"
  Normal  Pulled          58s   kubelet            Successfully pulled image "quay.io/openshiftroadshow/mapit@sha2
56:1366b430c7d4bddf35c7b2d067bc24e8d67ba297dbaacd10e0d80939efd1de9d" in 6.14s (6.14s including waiting)
  Normal  Created         58s   kubelet            Created container mapit
  Normal  Started         58s   kubelet            Started container mapit
----
...
TargetPort:        8080/TCP
Endpoints:         10.128.2.103:8080
Port:              8778-tcp  8778/TCP
TargetPort:        8778/TCP
Endpoints:         10.128.2.103:8778
Port:              9779-tcp  9779/TCP
TargetPort:        9779/TCP
Endpoints:         10.128.2.103:9779
...
metadata:
  annotations:
    openshift.io/generated-by: OpenShiftNewApp
  creationTimestamp: "2024-07-01T14:09:05Z"
  labels:
    app: mapit
    app.kubernetes.io/component: mapit
    app.kubernetes.io/instance: mapit
  name: mapit
  namespace: app-management
  resourceVersion: "381508"
  uid: 2c65dc97-9348-4b6f-b692-4f93d8bc60aa
spec:
  clusterIP: 172.30.121.200
  clusterIPs:
  - 172.30.121.200
...
Port:              8080-tcp  8080/TCP
TargetPort:        8080/TCP
Endpoints:         10.128.2.103:8080,10.131.0.112:8080
Port:              8778-tcp  8778/TCP
TargetPort:        8778/TCP
Endpoints:         10.128.2.103:8778,10.131.0.112:8778
Port:              9779-tcp  9779/TCP
TargetPort:        9779/TCP
Endpoints:         10.128.2.103:9779,10.131.0.112:9779
Session Affinity:  None
Events:            <none>
----
...
image::images/mapit-app-route.png[width=30%]
