...
----
Name:             mapit-595987c59c-vr7l7
Namespace:        app-management
Priority:         0
Service Account:  default
Node:             ip-10-0-33-207.us-east-2.compute.internal/10.0.33.207
Start Time:       Mon, 20 May 2024 12:38:14 +0000
Labels:           deployment=mapit
                  pod-template-hash=595987c59c
Annotations:      k8s.ovn.org/pod-networks:
                    {"default":{"ip_addresses":["10.128.2.26/23"],"mac_address":"0a:58:0a:80:02:1a","gateway_ips":
...
IPs:
  IP:           10.128.2.26
Controlled By:  ReplicaSet/mapit-595987c59c
Containers:
  mapit:
    Container ID:   cri-o://374e17fedd19514d3daf85140601195bee2a63556c22842ab918b9fe10fac8ca
...
9efd1de9d
    ...
    State:          Running
      Started:      Mon, 20 May 2024 12:38:23 +0000
    Ready:          True
    Restart Count:  0
    ...
    Mounts:
      ...
      /var/run/secrets/kubernetes.io/serviceaccount from kube-api-access-l4vhn (ro)
Conditions:
  Type              Status
  Initialized       True
  Ready             True
...
Events:
  ...
  ----    ------                  ----  ----                     -------
  Normal  Scheduled               37m   default-scheduler        Successfully assigned app-management/mapit-595987
c59c-vr7l7 to ip-10-0-33-207.us-east-2.compute.internal
  Normal  SuccessfulAttachVolume  37m   attachdetach-controller  AttachVolume.Attach succeeded for volume "pvc-07f
ed757-188c-4adc-9c92-37d9964fcfbb"
  Normal  AddedInterface          37m   multus                   Add eth0 [10.128.2.26/23] from ovn-kubernetes
  Normal  Pulled                  37m   kubelet                  Container image "quay.io/openshiftroadshow/mapit@
sha256:1366b430c7d4bddf35c7b2d067bc24e8d67ba297dbaacd10e0d80939efd1de9d" already present on machine
  Normal  Created                 37m   kubelet                  Created container mapit
  Normal  Started                 37m   kubelet                  Started container mapit
----
