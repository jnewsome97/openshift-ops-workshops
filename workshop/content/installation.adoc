...
When accessing the console for the first time you should switch from `All Clusters` to `local-clsuter`. We will be using the local-cluster for the majority of the excerises (apart from ACM).
