...
It should look something like this (make sure to add the namespace field like below):
...
[start=7]
7. Navigate to the Results screen, allow the scan to complete, it can take up to 20-30 minutes for to finish up the enforcement.
