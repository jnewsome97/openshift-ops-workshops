...
link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html/networking/ovn-kubernetes-network-plugin#about-ovn-kubernetes[the official documentation].
